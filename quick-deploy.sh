#!/bin/bash
# ------------------------------------------------------
# QUICK DEPLOY - Deploy automático com Git integrado
# Faz commit automático + deploy completo em um comando
# Uso: ./quick-deploy.sh "Mensagem do commit" "Versão"
# ------------------------------------------------------
...
if [ "$#" -ne 2 ]; then
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "🚀 QUICK DEPLOY - Deploy Automático Completo"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
...
log_write "Resumo do Quick Deploy" "$UPDATE_LOG"
